...
class PseudoQueue:
    ...
    def __init__(self):
        self.enque_mystack=Stack()
        self.deque_mystack=Stack()
    ...
    def dequeue (self):
        ...
        """
        if self.enque_mystack.is_empty():
            raise IndexError("the queue is empty .. ")

        while self.enque_mystack.is_empty()!=None:
            self.deque_mystack.push(self.enque_mystack.pop())

        result=self.deque_mystack.pop()

        while self.deque_mystack.is_empty()!=None:
            self.enque_mystack.push(self.deque_mystack.pop())
